...
if (isset($_POST['login'])) {
  ...
  $query = mysqli_query($config, "SELECT * FROM siswa WHERE nis = '$nis' AND nama = '$nama'");
...
<div class="container mt-3 p-4 d-flex justify-content-center" >
  <div class="mt-4 p-4 border border-secondary border-4 rounded bg-light bg-opacity-10" style="width:auto">
      <h1 class="text-center mb-5">LOGIN SISWA</h1>
      <form method="POST">
        <div class="mb-3">
          <label for="exampleInputEmail1" class="form-label">NIS</label>
          <input type="text" class="form-control" aria-describedby="emailHelp" name="nis">
        </div>
        <div class="mb-3">
      ...
      <a href="admin_siswa.php">masuk siswa</a>
  </div>
</div>
