...
if (isset($_POST['submit'])) {
    ...
    $query = mysqli_query($config, "INSERT INTO buku(penulis, tahun, judul, kota, penerbit, cover, sinopsis, stock) VALUES('$penulis', '$tahun', '$judul', '$kota', '$penerbit', '$cover', '$sinopsis', '$stock')");
